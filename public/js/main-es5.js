...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function openDialog() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result) _this.postService.salvar(result.post, result.arquivo);
          });
        }
      }]);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".float-button[_ngcontent-%COMP%] { \r\n    position: fixed;\r\n    bottom: 40px;\r\n    right: 40px;\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
    ...
    PostDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PostDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Digite aqui o seu email");
  ...
  function srcAppPostServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PostService = /*#__PURE__*/function () {
      function PostService(http) {
        ...
        this.http = http;
        this.posts = [];
        this.http.get("http://localhost/laravel/public/api").subscribe(function (posts) {
          return posts.forEach(function (e) {
            return _this2.posts.push(new _post__WEBPACK_IMPORTED_MODULE_2__["Post"](e.nome, e.titulo, e.subtitulo, e.email, e.mensagem, e.arquivo, e.id, e.likes));
          });
        });
      }
      ...
      _createClass(PostService, [{
        ...
        value: function salvar(post, file) {
          ...
          this.http.post("http://localhost/laravel/public/api", uploadData, {
            observe: 'events'
          }).subscribe(function (event) {
            if (event.type == _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpEventType"].Response) {
              var e = event.body;

              _this3.posts.push(new _post__WEBPACK_IMPORTED_MODULE_2__["Post"](e.nome, e.titulo, e.subtitulo, e.email, e.mensagem, e.arquivo, e.id, e.likes));
            }
          });
        }
      }, {
        ...
        value: function like(id) {
          ...
          this.http.get("http://localhost/laravel/public/api/like/".concat(id)).subscribe(function (event) {
        ...
        value: function apagar(id) {
          ...
          this.http["delete"]("http://localhost/laravel/public/api/".concat(id)).subscribe(function (event) {
    ...
    PostComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PostComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("src", "http://localhost/laravel/public/storage/", ctx.post.arquivo, "", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\iaraa\Desktop\walace\programas\htdocs\laravel\resources\meuapp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
