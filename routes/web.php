...
/**
* Aula de relacionamento muitos pra muitos
*
*/

Route::get("b/desenvolvedor_projetos", function(){
...
Route::get("b/projetos_desenvolvedores", function(){
	...
	foreach($projetos as $p){
		...
		if(count($p->desenvolvedores) > 0){
			...
			foreach($p->desenvolvedores as $d){
				...
				echo "Cargo: $d->cargo | ";
				echo "horas do trabalhadas:". $d->pivot->horas_semanais;
			}
			echo "</ul><hr>";
		}
	}	
...
Route::get("b/desalocar", function(){
	$proj = Projeto::find(4);
	if(isset($proj)){
