    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <form method="POST" action="http://localhost/laravel/public/g" enctype="multipart/form-data">
            @csrf
          ...
          <div class="row">
                if(isset($posts))
                    ...
                    <div class="card mb-4 shadow-sm">
                        <img class="card-img-top figure-img img-fluid rounded" src="http://localhost/laravel/public/storage/{{ $post->arquivo }}">    
                        <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a type="button" class="btn btn-sm btn-outline-secondary" href="http://localhost/laravel/public/g/download/{{ $post->id }}">Download</a>
                            <form method="POST" action="http://localhost/laravel/public/g/{{$post->id}}">
                                @csrf
